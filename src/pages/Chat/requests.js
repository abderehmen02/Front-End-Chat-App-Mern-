...
function Requests({requestsArray}) {
 ...
 <div className='requestName text-center w-100 '> {Person.name} </div> <small className='requestUserName text-center text-muted ' > {Person.userName}  </small> 
         </div>       </div>
            })}
        </div>
    </div>
